# Generated by Django 4.0.2 on 2022-03-30 18:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_on_article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='newsapp.article')),
        ...
        migrations.AddField(
            model_name='article',
            name='article_editor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='newsapp.editor'),
        ),
    ]
